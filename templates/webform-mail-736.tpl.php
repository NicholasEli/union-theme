...
<html>
  <head>
    ...
    <title>Customer Fitment/Sizing Form | Union Binding Company</title>
    <style type="text/css">
              table[class=body] h1 {
      ...
      <tr>
        ...
        <td class="container" style="font-family:sans-serif;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;Margin:0 auto !important;">
          <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
            ...
            <span class="preheader" style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;visibility:hidden;width:0;">New Customer Fitment/Sizing Form has been delivered from unionbindingcompany.com</span>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                    <tr>
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                        ...
                        <br>
                        <h1 style="color:#000000;font-family:sans-serif;font-weight:400;line-height:1.4;margin:0;Margin-bottom:30px;font-size:25px;font-weight:800;text-align:left;text-transform:uppercase;">Customer Fitment/Sizing Form</h1>
